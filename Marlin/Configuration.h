...
#define STRING_CONFIG_H_AUTHOR "Guttener v1.1 BugFix" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Guttner v2.1 BugFix"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -6, -1.25 }
